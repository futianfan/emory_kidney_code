...
droplist = ['unosstat_waitlist_ki'] + stateVariables + ['rsex_22'] \
  + ['don_hiv_22'] + ['matc_22'] + ['usrds_id','gf_6months','gf_3year']
...
nonCategoricalVariables = list(trainData[features].columns[trainData.dtypes == float])
categoricalVariables = list(trainData[features].columns[trainData.dtypes == object])
